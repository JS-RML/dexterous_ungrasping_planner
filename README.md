...
Detailed the implementation of dexterous ungrasping on the UR10 robot arm platform can be found in [Dexterous Ungrasping](https://github.com/HKUST-RML/shallow_depth_insertion).
