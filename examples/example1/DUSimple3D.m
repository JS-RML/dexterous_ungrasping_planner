classdef DUSimple3D < handle
    ...
    methods
        ...
        function position = steer(this, nearest_node, new_node_position)
            sample_rate = 5; %numbers of sample of the slope of diagonal path, 2: fixed slope
            if nearest_node == 1
        ...
        function collision = obstacle_collision(this, new_node_position, nearest_node_ind)
            ...
            for i=0:sample_rate
                ...
                thumb_c  = is_thumb_collision(config(1), config(2), config(3), 0);
        ...
        function plot(this)
            ...
            load("regions/grey_region(dft0).mat", "P")
            P(:,3) = P(:,3);
            ...
            %plot obs region
            load("regions/thumb_collision(dft0).mat", "T_OBS")
            T_OBS(:,3) = T_OBS(:,3);
            set(findall(gca, 'Type', 'Line'),'LineWidth',1);
            grid on
